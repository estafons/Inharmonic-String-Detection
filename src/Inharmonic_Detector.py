...
class StringBetas():
    ...
    def set_limits(self, constants):
        ...
        constants.upper_limit =  max_beta*2**((constants.no_of_frets+6)/6) # +2 fret margin. didnt ceil up to the nearest, because sometimes 10**-3 appear ceiling up to 10**-2 making a huge difference
